...
(function() {
	...
	describe('CreatorController', function() {
		...
		//	});
        //
		//	// Create a sample creator array that includes the new article
		//	var sampleArticles = [sampleArticle];
        //
		//	// Set GET response
		//	$httpBackend.expectGET('creator').respond(sampleArticles);
        //
        ...
        //
		//	// Set POST response
		//	$httpBackend.expectPOST('creator', sampleArticlePostData).respond(sampleArticleResponse);
        //
		//	// Run controller functionality
		//	scope.create();
		//	$httpBackend.flush();
		...
		//	expect($location.path()).toBe('/creator/' + sampleArticleResponse._id);
		//}));
        //
		...
		//	expect($location.path()).toBe('/creator/' + sampleArticlePutData._id);
		//}));
        //
		...
		//	});
        //
		//	// Create new creator array and include the article
